function outstruct = parallelgurobi(args)
...
%   Algorithm groups are [LB, DetRob, rRobustGnl, rRobustGnl2_gurobi, rsGnl2, Fmax, rRoblower, rRobupper] (intlinprog refers to max (r,s) robustness)
...
%         A = diag(diag(L)) - L;
    ...
    % rRobustGnl2
    if algnum == 4
        rRG2struct = rRobustGnl2_gurobi(struct('L',L,'print',print,'threads',1));
    ...
    % rRobupper
    if algnum == 7
        rupstruct = rRoblower(struct('L',L,'print',print));
